...
void MainWindow::joyCtlVector()
{
    ...
    while (1)
    {
        ...
        // 按键控制
        // up
        if ((ev.type == 1) && (ev.code == 290) && (ev.value == 1))
        {
            heroVector.keyMoveState[0] = 1;
        }
        if ((ev.type == 1) && (ev.code == 290) && (ev.value == 0))
        {
            heroVector.keyMoveState[0] = 0;
        }
        // right
        if ((ev.type == 1) && (ev.code == 292) && (ev.value == 1))
        {
            heroVector.keyMoveState[1] = 1;
        }
        if ((ev.type == 1) && (ev.code == 292) && (ev.value == 0))
        {
            heroVector.keyMoveState[1] = 0;
        }
        // down
        if ((ev.type == 1) && (ev.code == 293) && (ev.value == 1))
        {
            heroVector.keyMoveState[2] = 1;
        }
        if ((ev.type == 1) && (ev.code == 293) && (ev.value == 0))
        {
            heroVector.keyMoveState[2] = 0;
        }
        // left
        if ((ev.type == 1) && (ev.code == 291) && (ev.value == 1))
        {
            heroVector.keyMoveState[3] = 1;
        }
        if ((ev.type == 1) && (ev.code == 291) && (ev.value == 0))
        {
            heroVector.keyMoveState[3] = 0;
        }
        // A
        if ((ev.type == 1) && (ev.code == 299) && (ev.value == 1))
        {
            heroVector.m_shootState = 1;
        }
        if ((ev.type == 1) && (ev.code == 299) && (ev.value == 0))
        {
            heroVector.m_shootState = 0;
        }
        // B
        if ((ev.type == 1) && (ev.code == 298) && (ev.value == 1))
        {
            heroVector.m_shootState = 1;
        }
        if ((ev.type == 1) && (ev.code == 298) && (ev.value == 0))
        {
            heroVector.m_shootState = 0;
        }
        // Y
        if ((ev.type == 1) && (ev.code == 296) && (ev.value == 1))
        {
            heroVector.keyMoveState[4] = 1;
        }
        if ((ev.type == 1) && (ev.code == 296) && (ev.value == 0))
        {
            heroVector.keyMoveState[4] = 0;
        }
        // X
        if ((ev.type == 1) && (ev.code == 297) && (ev.value == 1))
        {
            heroVector.keyMoveState[4] = 1;
        }
        if ((ev.type == 1) && (ev.code == 297) && (ev.value == 0))
        {
            heroVector.keyMoveState[4] = 0;
        }
        // C
        if ((ev.type == 1) && ((ev.code == 301) || (ev.code == 201)) && (ev.value == 1))
        {
            flag_stop = 1;
            emit flag_stop_signal(flag_stop);
        }
        // D
        if ((ev.type == 1) && ((ev.code == 300) || (ev.code == 200)) && (ev.value == 1))
        {
            flag_stop = 1;
            emit flag_stop_signal(flag_stop);
        }
